return {
	mod_name = {
		en = "Crosshairs Fix",
		ru = "Исправление: прицелы",
		["zh-cn"] = "准星修复",
	},
	mod_description = {
		en = "Fixes crosshairs to be actually representative of spread, taking your FOV into account.",
		ru = "Crosshairs Fix - Исправление для прицелов, которое показывает фактический разброс с учётом вашего поля зрения.",
		["zh-cn"] = "修复准星，在考虑 FOV 因素的情况下，使其准确反映武器散布范围。",
	},
	...
	shotshell_spread_crosshair_center_tooltip = {
		...
		ru = "Переключает выравнивание расширения прицелов относительно разброса: по центру или по периметру зоны разброса дроби.",
	},
